...
REPO_LINK: process.env.REPO_LINK || "https://github.com/jerrymd-1/subhan-xmd",
REPO_NAME: process.env.REPO_NAME || "subhan-xmd",
BOT_NAME: process.env.BOT_NAME || "SUBHAN-MD",
DESCRIPTION: process.env.DESCRIPTION || "SUBHAN MD PAKISTANI POWERFULL WHATSAPP BOT",
OWNER_NUMBER: process.env.OWNER_NUMBER || "923554583937",
OWNER_NAME: process.env.OWNER_NAME || "ArslanMD Official",
ST_SAVE: process.env.ST_SAVE || "SUBHAN-MD-STATUS-SERVER",
BIO_TEXT: process.env.BIO_TEXT || "SUBHAN-MD-BY-ARSLANMD-OFFICIAL",
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*`STATUS SEEN BY SUBHAN-MD`* _*POWERD BY*_ *ArslanMD Official Whtsapp Bot*",
FOOTER: process.env.FOOTER || "SUBHAN-MD",
COPYRIGHT: process.env.COPYRIGHT || "*㋛ SUBHAN-MD BY ARSLAN-MD OFFICIAL*",
...
ALIVE_IMG: process.env.ALIVE_IMG || "https://pro-hostify.free.nf//uploads/e95bec98_file_0000000014cc71fabc4b2e31bdf297e8.png",
OWNER_IMG: process.env.OWNER_IMG || "https://pro-hostify.free.nf//uploads/e95bec98_file_0000000014cc71fabc4b2e31bdf297e8.png",
